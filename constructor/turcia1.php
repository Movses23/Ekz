...
$countryname = R::load('country', '2');
$country = $countryname->name;

//Берем данные из бд для городов

$cityname1 = R::load('city', '4');
$city1 = $cityname1->name;

$cityname2 = R::load('city', '5');
$city2 = $cityname2->name;

$cityname3 = R::load('city', '6');
...
Нет - 0 руб.<br>
Романтика на Босфоре: прогулка на яхте класса люкс - 13000 руб.<br>
«Великолепный век». Любовь Роксоланы - 16000 руб.<br>
Фотопрогулка "Стамбул — город" - 13500 руб.<br>
...
<FORM action='turcia1.php' method='GET' >
...
if(($_GET['ListBox']) == "Стамбул")
    {
        $b = $cityname1->price;
		$b1 = 'Стамбул';
		
    }
    if(($_GET['ListBox']) == "Анкара")
    {
        $b = $cityname2->price;
		$b1 = 'Анкара';		
    }
    if(($_GET['ListBox']) == "Измир")
    {
        $b = $cityname3->price;
		$b1 = 'Измир';		
    }
    ...
    if(($_GET['ListBox2']) == "Романтика на Босфоре: прогулка на яхте класса люкс")
    {
        $d = $exname2->price;
		$d1 = 'Романтика на Босфоре: прогулка на яхте класса люкс';
    }
    if(($_GET['ListBox2']) == "«Великолепный век». Любовь Роксоланы")
    {
        $d = $exname3->price;
		$d1 = '«Великолепный век». Любовь Роксоланы';		
    }
    if(($_GET['ListBox2']) == "Фотопрогулка Стамбул — город")
    {
        $d = $exname4->price;
		$d1 = 'Фотопрогулка Стамбул — город';
    }
    if(($_GET['ListBox3']) == "5")
    {
        $i = 5;
